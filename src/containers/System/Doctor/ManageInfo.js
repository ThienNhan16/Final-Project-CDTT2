...
class ManageInfo extends Component {
  ...
  async componentDidMount() {
    ...
    const filteredUser = listUsers.filter((user) => user.id === userInfo.id)[0];

    let imageBase64 = "";
    if (filteredUser?.image) {
      imageBase64 = new Buffer(filteredUser.image, "base64").toString("binary");
    }
    console.log(filteredUser);

    this.setState({
      userEditId: filteredUser.id,
      ...
      role: filteredUser.roleId,
      position: filteredUser.positionId,
      avatar: "",
      previewImgURL: imageBase64,
      action: "EDIT",
      filteredUserEditId: filteredUser.id,
    });
  }
              ...
              <div className="row">
                ...
                <div className="col-12 my-3">
                  <button
                    ...
                    onClick={() => {
                      this.handleSaveUser(filteredUser);
                    }}
                  >
                    {this.state.action === CRUD_ACTIONS.EDIT ? (
